...
// // import { Calendar,Search,Weight } from 'lucide-react';
// import { Button } from '@/components/ui/button';
// import { Input } from '@/components/ui/input';
// import { GoogleGenerativeAI } from '@google/generative-ai';
// import { getUserByEmail,saveCollectedWaste,saveReward,updateTaskStatus, getWasteCollectionTask } from '@/database/action';
...
//                     setUser(fetchUser)
//                 }else{
//                     toast.error('user not logged in.Plese log in')
//                 }
//             }else{
...
//         }catch(error){
//                   console.log('error while fetching task on collect page :',error);
//                   toast.error("failed to load user data and tasks.Please try again later")
