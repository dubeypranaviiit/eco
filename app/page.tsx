...
import {ArrowRight,Users, MapPin,Globe,Coins,ChevronRight, Trash,  Medal, Settings,  Car, Leaf,Recycle } from "lucide-react"
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { AnimatedGlobe } from "@/components/animation/animatedGlobe";
  ...
  return (
    ...
    <section className="text-center mb-20">
      ...
      <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
        EcoRevive <span className="text-green-600">Waste Management</span>
      </h1>
